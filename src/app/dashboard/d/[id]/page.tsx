  ...
  return (
    <div className="min-h-screen bg-cream-grain text-ink">
      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
        <Link
          href="/dashboard"
          className="mb-8 inline-block font-mono text-[11px] uppercase tracking-[0.15em] opacity-60 transition hover:opacity-100"
        >
          ← Retour
        </Link>
        ...
        <div className="mb-16 grid gap-12 md:grid-cols-[2fr_3fr]">
          {/* Aperçu */}
          <div>
            <div className="relative mb-4 aspect-[4/3] bg-ink/10">
              {drop.imageUrl && (
                <Image
                  src={drop.imageUrl}
                  alt=""
          ...
          <div>
            ...
            <h1 className="mb-6 font-display text-4xl leading-[1.05] md:text-5xl">
              {content.hook.title}
            </h1>
